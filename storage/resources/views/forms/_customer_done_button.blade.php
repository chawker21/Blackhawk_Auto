...
{{ Form::submit ('Check Out', ['class' => "btn btn-info  btn-xs chk-btn", 'style' => 'margin-left:15px; margin-top:-2px; float:right;']) }}
{!! Form::close() !!}
@else
    {!! Form::model($customer_info, ['route' => ['customer.done', $customer_info->id]])  !!}
    {!! Form::hidden('_method', 'PATCH') !!}

    {{ Form::submit ('Check In', ['class' => "btn btn-info  btn-xs chk-btn", 'style' => 'margin-left:15px; margin-top:-2px; float:right;']) }}
    {!! Form::close() !!}
